<div class="items">
    ...
    $plugin=UsualToolCMSDB::queryData("cms_plugins","","","hid desc","","0")["querydata"];
    foreach($plugin as $pluginrow):
        ...
        while(($file = readdir($current_dir)) !== false) {
            ...
            readplugin($sub_dir);
                ...
                if($plugintype==2):
                    ...
                    if(UsualToolCMSDB::queryData("cms_plugins","","id='$zid'","","","0")["querynum"]>0):
