...
二、本协议许可的权利及义务
1、本公司支持任何团体或个人使用本软件构建公益性、非盈利性的网站或应用。
2、您可以在本协议规定的约束和限制范围内修改本软件源代码或界面风格以适应您网站或应用的要求。
3、使用本软件构建网站或应用，您拥有全部内容的所有权，并且您必须独立承担这些内容所产生的法律责任及法定义务，所涉及的一切争议纠纷和法律后果与本公司无关。
4、您可以将本软件应用于商业用途。若您购买有相关的技术支持内容，则可在技术支持期限内通过指定的方式获得指定范围内的技术支持服务。
5、所有用户均享有反映和提出意见的权力，相关意见将被作为首要考虑，但没有一定被采纳的承诺或保证。
三、本协议规定的约束和限制
1、您可以将本软件应用于商业用途，但必须保证本软件原始著作权人的相应权利不被损害。
2、不得将本软件的核心代码或与之关联的部分（插件、模块、模板等）进行版权注册、抵押或发放许可证。
3、不管您的网站或应用是否整体使用本软件，还是部份栏目使用本软件，您应当保留相关版权信息。
4、不得使用本软件构建政府法令条规所禁止的网站或应用。
5、如果您无法遵守本协议的各项条款，默认被许可的权利将自动终止，强行使用则需要承担相应的法律责任。
四、有限担保和免责声明
