...
if($_GET["do"]=="out"){
    ...
    echo"<script>alert('登出CMS Admin Panel成功!');window.location.href='ut-login.php'</script>";
}
if($_GET['do']=="login"){
            ...
            if(!empty($uuser)&&!empty($upass)):
                ...
                if($datas["querynum"]==1):
                    ...
                    if($shaupass==$rows['password']):
                        ...
                        echo"<script>alert('登陆CMS Admin Panel成功!');window.location.href='index.php'</script>";
                    else:
...
<title>UsualToolCMS 8.0 Release</title>
...
<h1>UsualToolCMS 8.0 Release</h1>
